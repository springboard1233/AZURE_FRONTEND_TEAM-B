      ...
      <div className='layout'>
        <aside className='sidebar'>
          ...
          <nav style={{ marginTop: 12 }}>
            ...
            <NavLink to='/forecasts' style={{ display: 'block', padding: '8px 10px' }}>
              Forecasts
            </NavLink>
            <NavLink to='/model-comparison' style={{ display: 'block', padding: '8px 10px' }}>
              Model Comparison
            </NavLink>
            <NavLink to='/monitoring' style={{ display: 'block', padding: '8px 10px' }}>
              Monitoring
            </NavLink>
          </nav>
